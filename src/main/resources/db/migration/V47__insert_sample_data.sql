...
INSERT INTO employee (id, first_name, email, department, salary, is_active) VALUES
                                                                                ...
                                                                                (5, 'Colombe', 'colomberakotonjanahary@gmail.com', 'IT', 1000000000, true),
                                                                                (6, 'Toto', 'toto@gmail.com', 'RH', 3000, false),
                                                                                (7, 'Mari', 'juana@gmail.com', 'Finance', 6000, true)
ON CONFLICT (id) DO NOTHING;

SELECT setval('employee_seq', (SELECT COALESCE(MAX(id), 0) FROM employee));
...
INSERT INTO intern (id, first_name, email, department, salary, is_remunerate, manager_id) VALUES
                                                                                              ...
                                                                                              (6, 'Anaelle', 'ctf-player@picoctf.org', 'Marketing', 6, false, 7),
                                                                                              (7, 'yolololol', 'colomberakotonjanahary@gmail.com', 'IT', 98888, false, 5),
                                                                                              (8, 'Coco', 'coco@gmail.com', 'IT', 1000, false, 5),
                                                                                              (9, 'Sasha', 'guest@picoctf.org', 'Finance', 400, true, 7),
                                                                                              (10, 'Colombekjlk', 'colomberakotonjanahary@gmail.com', 'Marketing', NULL, false, NULL),
                                                                                              (11, 'Colombe', 'you@gmail.com', 'RH', NULL, false, NULL),
                                                                                              (12, 'lmkmk', 'guest@picoctf.org', 'Finance', NULL, false, 7),
                                                                                              (13, 's', NULL, NULL, NULL, false, NULL)
ON CONFLICT (id) DO NOTHING;

SELECT setval('intern_seq', (SELECT COALESCE(MAX(id), 0) FROM intern));